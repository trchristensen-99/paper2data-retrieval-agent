    ...
    function buildDetailRows(record) {
      ...
      return {
        overview: [
          ...
          ['Publication Status', metadata.publication_status || ''],
          ['DOI', metadata.doi || ''],
          ['PMID', metadata.pmid || ''],
        ...
        data: [
          ...
          ['Code Repositories (VCS)', valueToText(record.vcs_repositories || record.code_repositories || [])],
          ['Code Archives', valueToText(record.archival_repositories || [])],
          ['Code Available', valueToText(record.code_available)],
